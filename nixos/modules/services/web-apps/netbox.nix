...
let
  ...
  settingsFile = (pythonFmt.generate "netbox-settings.py" cfg.settings) + optionalString cfg.enableLdap ''
    SOCIAL_AUTH_KEYCLOAK_SECRET = (open("${cfg.keycloakClientSecret}", "r").read().split("\n")[0])
  '';
